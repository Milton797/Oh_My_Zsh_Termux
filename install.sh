...
main() {
  ...
  url_zsh=git://github.com/robbyrussell/oh-my-zsh.git
  url_autosuggestions=git://github.com/zsh-users/zsh-autosuggestions.git
  dir_autosuggestions=$ZSH/custom/plugins/zsh-autosuggestions
  
  url_dot_termux=git://github.com/Milton797/Oh_My_Zsh_Termux.git
  ...
  echo -e "${YELLOW}1 of 3 .oh-my-zsh Download and copy.${NORMAL}\n" && sleep 3
  ...
  echo -e "${YELLOW}2 of 3 .termux Download and copy${NORMAL}\n" && sleep 3
  ...
  echo -e "${YELLOW}3 of 3 /.zsh-autosuggestions Download and copy.${NORMAL}\n" && sleep 3
  ...
  echo -e "\n${RED}Adding the agnoster theme which you can change later to anything in the $ZSHRC${NORMAL}"
